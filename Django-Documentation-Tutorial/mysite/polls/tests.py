...
def create_question(question_text, days):
	""" Creates a question with the given 'question text' and published the
...
class QuestionViewTests(TestCase):
	...
	def test_index_view_with_no_questions(self):
		""" If no question exists, an apprporiate message should be displayed """
...
class QuestionIndexDetailTests(TestCase):
	...
	def test_detail_view_with_a_future_question(self):
		""" The detail of a question with a pub_date in the future
		should return a 4040 not found """
